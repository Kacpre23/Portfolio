package ui.logic;//import java.util.Collections;
import javax.swing.*;
...
public class Class implements MyComperator {
    ...
    Student blank = new Student("","","",0 ,10);
    ...
    public void addStudent(String imie, String nazwisko, int rok) {
        ...
        Student adding = new Student(imie.toUpperCase(), nazwisko.toUpperCase(), "Nieokreslony", rok, 10);
   ...
   public void changeCondition(String student, String condition2) {
        for (Student student12 : listaStudentow) {
            if(student12.nazwisko.equals(student)) student12.stanStudenta = condition.toString(condition2);
        }
     //  setListaStudentow(listaStudentow);
    }
